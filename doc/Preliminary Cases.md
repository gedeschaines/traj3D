...
The reentry only drag ballistic trajectories generated by **traj3D1** with initial inertial conditions for each of three cases shown Table-6 are depicted as the green, red and blue paths from launch points to impact points in Figure-9.
 ...
 | 10 | saginawD_I | 1.0 | 0.0 | 5000 | 10497.16 | 138.2964 | 42.3469 | 527.022 | Red |
...
The ballistic trajectories for all three reentry drag case exhibit steeping of the gamma angle as the ejecta approaches its terminal velocity phase. For the observed green and non-rotational blue paths, the trajectory appears to remain on a constant bearing relative to the observer. For the inertial red path, the trajectory deviates from the elliptic launch plane in an eastward direction as the ejecta is influenced by the atmosphere above a rotating Earth.
