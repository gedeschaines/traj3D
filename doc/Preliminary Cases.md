...
The reentry only drag ballistic trajectories generated by **traj3D1** with initial inertial conditions for each of four cases shown Table-6 are depicted as the green, red, blue and purple paths from launch points to impact points in Figure-9.
