...
C   INITIALIZE NAMELIST VARIABLES
      ...
      RHOG = 1.75
      NPOUT = 1
      OPEN(UNIT=7,FILE="traj3D0_geod.dat",FORM="FORMATTED")
C                           INITIALIZE VALUES
   10 JACK=1
      KJACK=1
      I=5
      IPOUT = 0
      NHCHEK = 1
      RAD = 57.29578              ! DEGREES PER RADIAN
...
C     AZI = ATAN2(C3 + C1/COS(GAMREL/RAD)/C2)*RAD
      C1 = HRE*WE*DCOS(XL)
...
C************************************************************************
     ...
     1  NOUT,KJACK,IAERO,NCD,NMAC,ISWH,IOUT,IPASS,NPASS,IPUNCH,JDATE(3)
      ...
      DOUBLE PRECISION REQ, RPO, E2, RROP, F, A6
      DOUBLE PRECISION RE,H,AZR,GAMR,WE,T,GR,AD,AL,AY
      REAL MACH,MASS,MRAT,MOLW,LAT,LATG,LON
C                            LIST OUTPUT
...
C     LON = PHIX*RAD - WE*(T-TO)*RAD  ! INERTIAL TRAJ WRT To
